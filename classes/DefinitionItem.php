...
class DefinitionItem
{
    ...
    {
        $result = ['url' => trans('anikin.rememberthesitemap::lang.item.url')];
        $apiResult = Event::fire('anikin.rememberthesitemap.listTypes');
    ...
    {
        $result = [];
        $apiResult = Event::fire('anikin.rememberthesitemap.getTypeInfo', [$type]);
