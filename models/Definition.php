<?php namespace ANIKIN\RememberTheSitemap\Models;
...
use ANIKIN\RememberTheSitemap\Classes\DefinitionItem;
...
class Definition extends \Model
{
     ...
     */
    public $table = 'anikin_rememberthesitemap_definitions';
    ...
    public function generateSitemap()
    {
        ...
        foreach ($this->items as $item) {
             ...
             */
                ...
                $apiResult = Event::fire('anikin.rememberthesitemap.resolveItem', [$item->type, $item, $currentUrl, $theme]);
